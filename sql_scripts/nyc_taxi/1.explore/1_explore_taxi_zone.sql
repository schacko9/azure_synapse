...
FROM
    OPENROWSET(
        BULK 'https://synapseprojectdl1.dfs.core.windows.net/nyc-taxi-data/raw_data/taxi_zone.csv',
        FORMAT = 'CSV',
        PARSER_VERSION = '2.0'
    ) AS [result]
...
FROM
    OPENROWSET(
        BULK 'abfss://nyc-taxi-data@synapseprojectdl1.dfs.core.windows.net/raw_data/taxi_zone_without_header.csv',
        FORMAT = 'CSV',
        PARSER_VERSION = '2.0',
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '\n'
...
WITH(
    LOCATION = 'abfss://nyc-taxi-data@synapseprojectdl1.dfs.core.windows.net/raw_data'
)
